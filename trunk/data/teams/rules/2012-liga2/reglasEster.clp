...
(defrule EQUIPO-A::rey1
	...
	?y4 <- (- ?y1 1)
	?x4 <- (+ ?x1 2)
	(not(ficha (equipo "B") (num ?n3) (pos-x ?x3) (pos-y ?y1)))
	(not(ficha (equipo "B") (num ?n4) (pos-x ?x3) (pos-y ?y3)))
	(not(ficha (equipo "B") (num ?n5) (pos-x ?x3) (pos-y ?y4)))
	(not(ficha (equipo "B") (num ?n6) (pos-x ?x4) (pos-y ?y1)))
	(test (= (+ ?x2 1) ?x1 ) )
	=>
...
(defrule EQUIPO-A::rey2
	...
	?x3 <- (+ ?x1 1)
	?y3 <- (- ?y1 2)
	(not(ficha (equipo "B") (num ?n3) (pos-x ?x2) (pos-y ?y2)))
	(not(ficha (equipo "B") (num ?n4) (pos-x ?x3) (pos-y ?y2)))
	(not(ficha (equipo "B") (num ?n5) (pos-x ?x1) (pos-y ?y2)))
	(not(ficha (equipo "B") (num ?n6) (pos-x ?x1) (pos-y ?y3)))
	(test (= (+ ?x2 1) ?x1 ) )
	=>
...
(defrule EQUIPO-A::rey4
	...
	(not(ficha (equipo "B") (num ?n3) (pos-x ?x3) (pos-y ?y1)))
	(not(ficha (equipo "B") (num ?n4) (pos-x ?x3) (pos-y ?y3)))
	(not(ficha (equipo "B") (num ?n5) (pos-x ?x3) (pos-y ?y2)))
	(not(ficha (equipo "B") (num ?n6) (pos-x ?x4) (pos-y ?y1)))
	(test (= (- ?x2 1) ?x1 ) )
	=>
...
(defrule EQUIPO-A::rey5
	...
	(not(ficha (equipo "B") (num ?n4) (pos-x ?x3) (pos-y ?y2)))
	(not(ficha (equipo "B") (num ?n5) (pos-x ?x1) (pos-y ?y2)))
	(not(ficha (equipo "B") (num ?n6) (pos-x ?x1) (pos-y ?y4)))
	(test (= (- ?x2 1) ?x1 ) )
	=>
	(assert (mueve (num ?n1) (mov 4) (tiempo ?t)))) 
...
(defrule EQUIPO-A::rey7
	...
	(not(ficha (equipo "B") (num ?n3) (pos-x ?x3) (pos-y ?y1)))
	(not(ficha (equipo "B") (num ?n4) (pos-x ?x3) (pos-y ?y2)))
	(not(ficha (equipo "B") (num ?n5) (pos-x ?x3) (pos-y ?y3)))
	(not(ficha (equipo "B") (num ?n6) (pos-x ?x4) (pos-y ?y1)))
	(test (= (- ?y2 1) ?y1 ) )
	=>
	(assert (mueve (num ?n1) (mov 2) (tiempo ?t)))) 
...
(defrule EQUIPO-A::rey8
	...
	?y4 <- (- ?y1 2)
	?x4 <- (+ ?x1 1)
	(not(ficha (equipo "B") (num ?n3) (pos-x ?x1) (pos-y ?y3)))
	(not(ficha (equipo "B") (num ?n4) (pos-x ?x3) (pos-y ?y3)))
	(not(ficha (equipo "B") (num ?n5) (pos-x ?x4) (pos-y ?y3)))
	(not(ficha (equipo "B") (num ?n6) (pos-x ?x1) (pos-y ?y4)))
	(test (= (- ?y2 1) ?y1 ) )
	=>
	(assert (mueve (num ?n1) (mov 4) (tiempo ?t)))) 
