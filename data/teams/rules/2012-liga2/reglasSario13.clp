...
(defrule EQUIPO-A::defiende1casillaizq
	...
	(ficha (equipo "B") (num ?n2) (pos-x 3) (pos-y 2) )
	(tiempo ?t)
	=>
...
(defrule EQUIPO-A::defiende1casillaizq_aba
	...
	(ficha (equipo "B") (num ?n2) (pos-x ?xa) (pos-y ?ya-1) )
	(tiempo ?t)
	=>
...
(defrule EQUIPO-A::defensa1casilladerecha
	(declare (salience 80))
	(ficha (equipo "A") (num ?n1) (puntos 6))
	(ficha (equipo "B") (num ?n2) (pos-x 5) (pos-y 2) )
	(tiempo ?t)
	=>
...
(defrule EQUIPO-A::defiende2casillaizq
	(declare (salience 77))
	(ficha (equipo "A") (num ?n1) (pos-x ?xa) (pos-y ?ya) (puntos 6))
	(ficha (equipo "B") (num ?n2) (pos-x ?xa-2) (pos-y 2) )
	(tiempo ?t)
	=>
	(assert (mueve (num ?n1) (mov 2) (tiempo ?t)))) 
