...
(defrule EQUIPO-A::proteccion6
	(declare (salience 40))
	(ficha (equipo "A") (num ?nhizq) (pos-x ?x1) (pos-y ?y1) (puntos 6))
	(ficha (equipo "B") (pos-x ?x2) (pos-y ?y2)(descubierta 1))
	(tiempo ?t)
	(test (> ?y1 ?y2))
=>
	(assert (mueve (num ?nhizq) (mov 2) (tiempo ?t))))
...
(defrule EQUIPO-A::proteccion6
	(declare (salience 39))
	(ficha (equipo "A") (num ?nhder) (pos-x ?x1) (pos-y ?y1) (puntos 6))
	(ficha (equipo "B") (pos-x ?x2) (pos-y ?y2))
	(tiempo ?t)
	(test (> ?y1 ?y2))
=>
...
(defrule EQUIPO-A::seisprotecizq
	(declare (salience 39))
	(ficha (equipo "A") (num ?nhder) (pos-x ?x1) (pos-y ?y1) (puntos 1))
	(ficha (equipo "B") (pos-x ?x2) (pos-y ?y2)(puntos 6))
	(tiempo ?t)
	(test (= ?y1 ?y2))
=>
	(assert (mueve (num ?nhder) (mov 2) (tiempo ?t))))

(defrule EQUIPO-A::seisprotecder
	(declare (salience 39))
	(ficha (equipo "A") (num ?nhder) (pos-x ?x1) (pos-y ?y1) (puntos 1))
	(ficha (equipo "B") (pos-x ?x2) (pos-y ?y2)(puntos 6))
	(tiempo ?t)
	(test (= ?x1 ?x2))
=>
	(assert (mueve (num ?nhder) (mov 3) (tiempo ?t))))
