...
(defrule EQUIPO-A::esto_me_suena_6
  (declare(salience 35))
  ;Condiciones
  (tiempo > ?t 100)

  ;Seleccionamos al 6
  (ficha(equipo "A") (num ?n_reina) (pos-x ?x_reina) (pos-y ?y_reina) (puntos 6))
  (test (<> ?y_reina 5))
  
  =>
  ;Actuamos
  (assert (mueve(num ?n_reina)) (mov 4) (tiempo ?t))
)

(defrule EQUIPO-A::esto_me_suena_5
  (declare(salience 35))
  ;Condiciones
  (tiempo > ?t 100)

  ;Seleccionamos al 5
  (ficha(equipo "A") (num ?n_reina) (pos-x ?x_reina) (pos-y ?y_reina) (puntos 5))
  (test (<> ?y_reina 5))
