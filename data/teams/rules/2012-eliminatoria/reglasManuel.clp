...
(defrule EQUIPO-A::Huidareyabajo1
  (declare (salience 80))
  (tiempo ?t)
  (ficha (equipo "A") (num ?n) (puntos 1) (pos-x ?x) (pos-y ?y))
...
(defrule EQUIPO-A::huidareyarriba1
  (declare (salience 80))
  (tiempo ?t)
  (ficha (equipo "A") (num ?n) (puntos 1) (pos-x ?x) (pos-y ?y))
  (ficha (equipo "B") (pos-x ?x1) (pos-y ?y))
...
;Si hay alguien debajo del rey y a la izquierda está libre
(defrule EQUIPO-A::huidarreyizq1
  (declare (salience 80))
  (tiempo ?t)
  (ficha (equipo "A") (num ?n) (puntos 1) (pos-x ?x) (pos-y ?y))
  (ficha (equipo "B") (pos-x ?x) (pos-y ?y1))
...
;Si hay alguien debajo del rey y a la izquierda está libre
(defrule EQUIPO-A::huidarreyizq2
  (declare (salience 80))
  (tiempo ?t)
  (ficha (equipo "A") (num ?n) (puntos 1) (pos-x ?x) (pos-y ?y))
  (ficha (equipo "B") (pos-x ?x1) (pos-y ?y))
...
(defrule EQUIPO-A::huidareyderecha
  (declare (salience 80))
  (tiempo ?t)
  (ficha (equipo "A") (num ?n) (puntos 1) (pos-x ?x) (pos-y ?y))
  (ficha (equipo "B") (pos-x ?x) (pos-y ?y1))
...
;Si hay alguien a la derecha del rey y a la derecha está libre
(defrule EQUIPO-A::huidareyderecha1
  (declare (salience 80))
  (tiempo ?t)
  (ficha (equipo "A") (num ?n) (puntos 1) (pos-x ?x) (pos-y ?y))
  (ficha (equipo "B") (pos-x ?x) (pos-y ?y1))
