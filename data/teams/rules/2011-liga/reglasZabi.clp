...
;           para el Equipo-A (Formacion ZABI)          ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;     AUTOR:    ALVARO ZABALLA FERNANDEZ, 2011         ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Ocupar posiciones Iniciales                          ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(defrule EQUIPO-A::posicionar1
	(declare (salience 74))
	(tiempo ?t)
	(ficha (equipo "A") (num ?n) (pos-x 3) (pos-y 2) (puntos 6))
	=>
...
(defrule EQUIPO-A::posicionar2
	(declare (salience 73))
	(tiempo ?t)
	(ficha (equipo "A") (num ?n) (pos-x 2) (pos-y 2) (puntos 5))
	=>
	(assert (mueve (num ?n) (mov 3) (tiempo ?t)))) 
...
(defrule EQUIPO-A::posicionar3
	(declare (salience 73))
	(tiempo ?t)
	(ficha (equipo "A") (num ?n) (pos-x 2) (pos-y 1) (puntos 1))
	=>
	(assert (mueve (num ?n) (mov 3) (tiempo ?t)))) 

(defrule EQUIPO-A::posicionar4
	(declare (salience 73))
	(tiempo ?t)
	(ficha (equipo "A") (num ?n) (pos-x 2) (pos-y 2) (puntos 1))
	=>
	(assert (mueve (num ?n) (mov 1) (tiempo ?t)))) 

;(defrule EQUIPO-A::posicionar5
;	(declare (salience 72))
;	(tiempo ?t)
;	(ficha (equipo "A") (num ?n) (pos-x 1) (pos-y 2) (puntos 5))
;	=>
;	(assert (mueve (num ?n) (mov 3) (tiempo ?t)))) 
...
;	(declare (salience 72))
;	(tiempo ?t)
;	(ficha (equipo "A") (num ?n) (pos-x 1) (pos-y 1) (puntos 4))
;	=>
;	(assert (mueve (num ?n) (mov 3) (tiempo ?t)))) 

;(defrule EQUIPO-A::posicionar6
;	(declare (salience 72))
;	(tiempo ?t)
;	(ficha (equipo "A") (num ?n) (pos-x 3) (pos-y 1) (puntos 2))
;	=>
...
(defrule EQUIPO-A::posicionar5
	(declare (salience 72))
	(tiempo ?t)
	(ficha (equipo "A") (num ?n) (pos-x 2) (pos-y 3) (puntos 5))
	=>
	(assert (mueve (num ?n) (mov 3) (tiempo ?t)))) 
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;Guerra de guerrillas con los 2                       ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
