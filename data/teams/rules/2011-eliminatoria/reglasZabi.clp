...
(defrule EQUIPO-A::posicionar1
	(declare (salience 74))
	(tiempo ?t)
	(ficha (equipo "A") (num ?n) (pos-x 6) (pos-y 2) (puntos 6))
	=>
...
(defrule EQUIPO-A::posicionar3
	(declare (salience 73))
	(tiempo ?t)
	(ficha (equipo "A") (num ?n) (pos-x 7) (pos-y 1) (puntos 1))
	=>
	(assert (mueve (num ?n) (mov 3) (tiempo ?t)))) 
...
(defrule EQUIPO-A::posicionar4
	(declare (salience 73))
	(tiempo ?t)
	(ficha (equipo "A") (num ?n) (pos-x 7) (pos-y 2) (puntos 1))
	=>
...
(defrule EQUIPO-A::posicionar5
	(declare (salience 72))
	(tiempo ?t)
	(ficha (equipo "A") (num ?n) (pos-x 7) (pos-y 3) (puntos 5))
	=>
	(assert (mueve (num ?n) (mov 3) (tiempo ?t)))) 
